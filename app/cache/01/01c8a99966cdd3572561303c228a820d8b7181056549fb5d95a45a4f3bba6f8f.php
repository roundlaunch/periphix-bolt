...
/* login/login.twig */
class __TwigTemplate_26a6ec1deafb6b7373b520aa1f7d6a4e016795ab458d736431fb9b9075a2e668 extends Twig_Template
{
...
";
    ...
    {
        return array (  112 => 42,  105 => 38,  101 => 37,  95 => 34,  91 => 33,  83 => 28,  76 => 24,  72 => 23,  68 => 22,  53 => 16,  47 => 13,  41 => 9,  38 => 8,  32 => 6,  28 => 2,  26 => 4,  11 => 2,);
    }
}
/* {# Page: Login #}*/
...
/* */
/*         <p class="login-group">*/
/*             <button type="submit" class="btn btn-primary" name="action" value="login"><i class="icon-signin"></i> {{ __('page.login.button.log-on') }}</button>*/
/*             <button type="button" class="btn btn-link login-forgot"> {{ __('page.login.button.forgot-password') }}</button>*/
/*         </p>*/
/*         <p style="display: none;" class="reset-group">*/
/*             <button type="submit" class="btn btn-primary" name="action" value="reset"><i class="icon-envelope"></i> {{ __('page.login.button.reset-password') }}</button>*/
